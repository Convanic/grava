...
// materialisiert er game_event; die Zustellung übernimmt der Dispatcher (Phase B).
...
$gameDispatcher = new \App\Game\GameNotificationDispatcher(
    $gameEventRepo, $notifServ, $gameRepo, $privacyZoneRepo, $gameConfig,
);
